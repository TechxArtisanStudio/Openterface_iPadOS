        ...
        ZStack {
            VStack(spacing: 0) {
                ...
                ZStack {
                    ...
                    ZoomStatusOverlay(cameraManager: appCoordinator.cameraManager)
                }
                    ...
                    if isZoomed {
                        VStack(spacing: 4) {
                            Image(systemName: "magnifyingglass")
                                .font(.system(size: 16))
                                .foregroundColor(.white)
                            Text("\(String(format: "%.2f", cameraManager.currentZoomFactor))x")
